...
-- Dumping structure for table git_j4c.blog
...
-- Dumping data for table git_j4c.category: ~79 rows (approximately)
...
-- Dumping structure for table git_j4c.company
...
-- Dumping data for table git_j4c.company: ~1 rows (approximately)
...
-- Dumping structure for table git_j4c.experience
...
-- Dumping data for table git_j4c.experience: ~0 rows (approximately)
/*!40000 ALTER TABLE `experience` DISABLE KEYS */;
/*!40000 ALTER TABLE `experience` ENABLE KEYS */;


-- Dumping structure for table git_j4c.interview_call
...
-- Dumping data for table git_j4c.interview_call: ~0 rows (approximately)
/*!40000 ALTER TABLE `interview_call` DISABLE KEYS */;
/*!40000 ALTER TABLE `interview_call` ENABLE KEYS */;


-- Dumping structure for table git_j4c.job
...
-- Dumping data for table git_j4c.job: ~3 rows (approximately)
/*!40000 ALTER TABLE `job` DISABLE KEYS */;
INSERT INTO `job` (`job_id`, `company_id`, `title`, `description`, `requirement`, `experience`, `month_salary`, `location`, `category`, `job_type`, `contract_duration`, `noj`, `date_close`, `status`, `date_create`, `date_modified`) VALUES
	(1, 1, 'PHP/ Web Programmer', 'Building web application', '["PHP","JavaScript","CSS","HTML","MySQL","CodeIgniter"]', '["3","year"]', '6000000-10000000', 'Subang', 'Pawang Web', 'contract', '1 tahun', '4', '2013-11-06', 'publish', '2013-10-26 21:17:45', '2013-11-09 16:06:00'),
	(2, 1, 'IT Staff', 'pemeliharaan komputer', '["koputer hardware","ms word, excel"]', '["1","year"]', '3000000', 'Jakarta Raya', 'Web-Masterweb', 'full_time', '0', '1', '2013-11-10', 'publish', '2013-10-27 21:43:55', '2013-11-09 16:05:41'),
	(3, 1, 'Java Programmer', 'Building java web applicattion', '["java","javascript"]', '["2","year"]', '6000000-10000000', 'Jakarta Raya', 'Programmer', 'full_time', '0', '1', '2013-11-07', 'publish', '2013-10-29 22:13:31', '2013-11-09 16:06:08');
/*!40000 ALTER TABLE `job` ENABLE KEYS */;


-- Dumping structure for table git_j4c.job_apply
CREATE TABLE IF NOT EXISTS `job_apply` (
  `job_apply_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `seeker_id` int(10) unsigned NOT NULL,
  `job_id` int(10) unsigned NOT NULL,
  `status_apply` enum('sent','delivered','read') NOT NULL DEFAULT 'sent',
...
-- Dumping data for table git_j4c.job_apply: ~0 rows (approximately)
/*!40000 ALTER TABLE `job_apply` DISABLE KEYS */;
/*!40000 ALTER TABLE `job_apply` ENABLE KEYS */;


-- Dumping structure for table git_j4c.language
...
-- Dumping data for table git_j4c.language: ~0 rows (approximately)
/*!40000 ALTER TABLE `language` DISABLE KEYS */;
/*!40000 ALTER TABLE `language` ENABLE KEYS */;


-- Dumping structure for table git_j4c.location
...
-- Dumping data for table git_j4c.location: ~42 rows (approximately)
...
-- Dumping structure for table git_j4c.mailer
...
-- Dumping structure for table git_j4c.position
...
-- Dumping data for table git_j4c.position: ~5 rows (approximately)
...
-- Dumping structure for table git_j4c.preference
...
-- Dumping data for table git_j4c.preference: ~0 rows (approximately)
/*!40000 ALTER TABLE `preference` DISABLE KEYS */;
/*!40000 ALTER TABLE `preference` ENABLE KEYS */;


-- Dumping structure for table git_j4c.qualification
...
-- Dumping data for table git_j4c.qualification: ~0 rows (approximately)
/*!40000 ALTER TABLE `qualification` DISABLE KEYS */;
/*!40000 ALTER TABLE `qualification` ENABLE KEYS */;


-- Dumping structure for table git_j4c.reference
...
-- Dumping data for table git_j4c.reference: ~0 rows (approximately)
/*!40000 ALTER TABLE `reference` DISABLE KEYS */;
/*!40000 ALTER TABLE `reference` ENABLE KEYS */;


-- Dumping structure for table git_j4c.seeker
...
-- Dumping structure for table git_j4c.sessions
...
INSERT INTO `sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES
	...
	('498618a2d3b16fe4adbe70c2aeafe0ce', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36', 1388812356, 'a:7:{s:9:"user_data";s:0:"";s:8:"login_id";s:32:"eb0a191797624dd3a48fa681d3061212";s:9:"seeker_id";s:1:"1";s:10:"first_name";s:7:"Nurhadi";s:9:"last_name";s:0:"";s:5:"email";s:22:"nurhadijogja@gmail.com";s:12:"reg_platform";s:6:"manual";}'),
	('5498041403b21ebd7cda49160a8ff559', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36', 1388812175, 'a:2:{s:9:"user_data";s:0:"";s:11:"private_key";i:598;}');
/*!40000 ALTER TABLE `sessions` ENABLE KEYS */;


-- Dumping structure for table git_j4c.skill
...
-- Dumping data for table git_j4c.skill: ~0 rows (approximately)
