...
<div class="row">
	<div class="span6 offset3">
		...
		<form class="form-horizontal" action="<?php echo base_url('company/login/test'); ?>" method="post">
			<div class="modal" style="position:relative; top:auto; left:auto; right:auto; margin:0 auto 20px; z-index:1; max-width:100%">
				<div class="modal-header">
					<h3><?php echo $this->lang->line('label_company_login'); ?></h3>
				</div>
				<div class="modal-body">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input autocomplete="off" type="text" name="login_email" id="login-email" value="<?php echo set_value('login_email'); ?>" placeholder="<?php echo $this->lang->line('label_email'); ?>" />
						</div>
					</div>
					<div class="control-group">
				...
				<div class="modal-footer">
					...
					<div class="pull-left">
						<a href="<?php echo base_url('company/login/recovery'); ?>"><?php echo $this->lang->line('label_cannot_access_account'); ?></a>
					</div>
				</div>
			</div>
		</form>
