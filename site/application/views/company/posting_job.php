...
<div class="container">
	<div class="row">
		<div class="span7">
			...
			<form class="form-horizontal" id="form-posting-job" method="post" action="<?php echo base_url('company/posting_job/save'); ?>">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="job_type" id="job_type">
							...
							<option <?php echo set_select('job_type', $type); ?> value="<?php echo $type; ?>"><?php echo $this->lang->line('label_'. $type); ?></option>
							<?php endforeach; ?>
						</select>
						
						<?php if(isset($_POST['contract_duration']) || @$_POST['job_type']=='contract'): ?>
							<input type="text" placeholder="<?php echo $this->lang->line('label_duration'); ?>..." name="contract_duration" id="contract-duration" value="<?php echo set_value('contract_duration'); ?>" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="description" id="description" rows="7" class="input-block-level"><?php echo set_value('description'); ?></textarea>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="date_close" id="date_close" value="<?php echo set_value('date_close'); ?>" class="span3" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="month_salary" id="month_salary" value="<?php echo set_value('month_salary'); ?>" class="span3" />
								...
								<?php if(! preg_match('/others?/i', $parent_name)): ?>
									...
									<optgroup label="<?php echo $plabel; ?>">
										<?php foreach($ctg as $c): ?>
											...
											<option <?php echo set_select('category', $c['name']) ?> value="<?php echo $c['name']; ?>"><?php echo $clabel; ?></option>
										<?php endforeach; ?>
									</optgroup>
								<?php endif; ?>
							<?php endforeach; ?>
							<option <?php echo set_select('category', 'others'); ?> value="others"><?php echo $this->lang->line('label_others'); ?></option>
						</select>
						
						<?php if(isset($_POST['category_other']) || @$_POST['category']=='others'): ?>
							<input type="text" name="category_other" id="category-other" value="<?php echo set_value('category_other'); ?>" />
							...
							<?php foreach($locations as $country=>$cities): ?>
								<optgroup label="<?php echo $country; ?>">
									<?php foreach($cities as $c): ?>
										<option <?php echo set_select('location', $c['city']); ?> value="<?php echo $c['city']; ?>"><?php echo $c['city']; ?></option>
									<?php endforeach; ?>
								</optgroup>							
							<?php endforeach; ?>
							<option <?php echo set_select('location', 'others'); ?> value="others"><?php echo $this->lang->line('label_others'); ?></option>
						</select>
						
						<?php if(isset($_POST['location_other']) || @$_POST['location']=='others'): ?>
							<input type="text" name="location_other" id="location-other" value="<?php echo set_value('location_other'); ?>" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="noj" id="noj" value="<?php echo set_value('noj'); ?>" class="span3" />
